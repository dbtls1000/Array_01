...
public class StrArray_05 {
	...
	// 보통 proto type을 만들었을때 void 형이 아닌경우 return문을 만들어야 한다.
	// return 형이 숫자이면 return 0;이라고 작성하고
	// 그외 형일 경우 return null;이라고 작성한다.
	public static String[] makeString(String strNation) {
		return null;
	}
